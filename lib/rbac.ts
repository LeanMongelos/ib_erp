...
export const PERMISSIONS: Permiso[] = [
  ...
  // Tesorería
  { clave: 'tesoreria.read',              modulo: 'tesoreria', descripcion: 'Ver tesorería' },
  { clave: 'tesoreria.manage',            modulo: 'tesoreria', descripcion: 'Gestionar cuentas y movimientos' },
  { clave: 'tesoreria.initial_balance',   modulo: 'tesoreria', descripcion: 'Cargar saldo inicial' },
  { clave: 'tesoreria.reconcile',         modulo: 'tesoreria', descripcion: 'Conciliar movimientos' },
  // Inventario
  ...
  // Compras
  { clave: 'compras.read',    modulo: 'compras', descripcion: 'Ver órdenes de compra y facturas' },
  ...
  { clave: 'compras.invoice', modulo: 'compras', descripcion: 'Registrar facturas de compra' },
  { clave: 'compras.pay',     modulo: 'compras', descripcion: 'Registrar pagos a proveedores' },
  // Fletes
  { clave: 'fletes.read',   modulo: 'fletes', descripcion: 'Ver seguimiento de fletes' },
  { clave: 'fletes.update', modulo: 'fletes', descripcion: 'Gestionar seguimiento de fletes' },
  // Servicio técnico
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  GERENTE: [
    ...
    'compras.read', 'compras.create', 'compras.approve', 'compras.receive', 'compras.invoice', 'compras.pay',
    'fletes.read', 'fletes.update',
  ...
  CONTABILIDAD: [
    ...
    'cobranzas.cheques.read', 'cobranzas.cheques.manage',
    'tesoreria.read', 'tesoreria.manage', 'tesoreria.initial_balance', 'tesoreria.reconcile',
    'compras.read', 'compras.approve', 'compras.invoice', 'compras.pay',
    'fletes.read', 'fletes.update',
    'reportes.read_financiero', 'reportes.read_fiscal',
    'emisores.read', 'emisores.create', 'emisores.update',
